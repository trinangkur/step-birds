...
DROP TABLE IF EXISTS RetweetWithComment;
CREATE TABLE RetweetWithComment (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  userId VARCHAR(20) NOT NULL,
  content VARCHAR(180) NOT NULL,
  timeStamp DATE(30) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  replyCount NUMERIC(5) NOT NULL DEFAULT 0,
  retweetCount NUMERIC(5) NOT NULL DEFAULT 0,
  parentUserName VARCHAR(30) NOT NULL,
  parentUserId VARCHAR(20) NOT NULL,
  parentTimeStamp DATE(30) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  parentTweetContent  VARCHAR(180) NOT NULL,
  FOREIGN KEY(userId) REFERENCES Tweeter(id)
);
